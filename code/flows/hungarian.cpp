...
struct Hungarian{
  ...
  Hungarian(int n)
    : n(n), c(n, vd(n, inf)), l(n, -1), r(n, -1), 
    p(n), sn(n), ds(n), u(n), v(n){}
  ld assign() {
    forn(i, n) forn(j, n) cin >> c[i][j]; // Set cost
